...
int ChienDau(ElementType *voSi1,ElementType *voSi2)
{
  ...
  if(voSi1->nhanhNhen>voSi2->nhanhNhen)
	...
	{
	  voSi2->mau=voSi2->mau-voSi1->tanCong+voSi2->phongThu;
	  voSi1->diem++;
	  printf("%s (%d) tan cong- %s (%d) mat %d mau\n",voSi1->bietHieu,voSi1->mau,voSi2->bietHieu,voSi2->mau,voSi1->tanCong-voSi2->phongThu);
	  if(voSi2->mau<=0)
	    {
	      if(lanDanh1==0)
		{
	    ...
	    lanDanh1=1;
	  voSi1->mau=voSi1->mau-voSi2->tanCong+voSi1->phongThu;
	  voSi2->diem++;
	  printf("%s (%d) tan cong- %s (%d) mat %d mau\n",voSi2->bietHieu,voSi2->mau,voSi1->bietHieu,voSi1->mau,voSi2->tanCong-voSi1->phongThu);
	  if(voSi1->mau<=0)
	    {
	      if(lanDanh2==0)
		{
